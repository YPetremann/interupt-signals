...
local function global_register(handler)
  script.on_event(defines.events.on_entity_renamed, handler)
end

-- MARK: -Handler Registry
local event = {}

--- register entity_renamed handler
---@param handler fun(event:EventData.on_entity_renamed)
---@return uint32
...
--- unregister entity_renamed handler
