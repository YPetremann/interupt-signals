...
local function global_register(handler, filters)
  ...
  script.on_event(defines.events.script_raised_built , handler, filters)
end
...
---@param filter LuaScriptRaisedBuiltEventFilter[]
---@param handler fun(event:EventData.script_raised_built  )
---@return uint32
...
---@param filter {handler:function}|{id:uint32}|{filter:LuaScriptRaisedBuiltEventFilter[]}
